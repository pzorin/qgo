...
Id<byte value="x9"/><byte value="x9"/>Numéro de la partie
Blanc/RB<byte value="x9"/>Nom Rang du joueur blanc
Noir/RN<byte value="x9"/>Nom Rang du joueur noir
Cp<byte value="x9"/><byte value="x9"/>numéro du coup joué au moment de la dernière mise à jour
Sz<byte value="x9"/><byte value="x9"/>taille
H<byte value="x9"/><byte value="x9"/>Handicap
K<byte value="x9"/><byte value="x9"/>Komi
By<byte value="x9"/><byte value="x9"/>Byoyomi (temps)
FR<byte value="x9"/><byte value="x9"/>Libre (FI), comptabilisée (I) ou pédagogique (TI)
(Ob)<byte value="x9"/><byte value="x9"/>Nombre d&apos;observateurs au moment de la dernière mise à jour
...
ob<byte value="x9"/>observing game (only one game visible)
Idle<byte value="x9"/>idle time
X<byte value="x9"/>private info: M..me, X..excluded from shout, W..watched (sort: X entries, then Rk)

or, if extended user info (Toolbox) is active (IGS only):
Info [Won/Lost] Idle (Country/Language)<byte value="x9"/>I could make a more cute table if someone is interesed in -&gt; send mail
...
talk<byte value="x9"/>talk to player (tab arises)
----
status<byte value="x9"/>show player&apos;s stats
stored games<byte value="x9"/>show stored games
results<byte value="x9"/>show results
rating<byte value="x9"/>show rating (NNGS only)
----
toggle watch list<byte value="x9"/>put/remove player to/from watch list - make &apos;W&apos; entry at &apos;X&apos; column; entry/leave sounds are activated
toggle exclude list<byte value="x9"/>same as watch - make &apos;X&apos; entry; player&apos;s shouts are no longer shown
...
Explication des symboles: (Cliquer sur la barre des symboles pour trier)
Stat<byte value="x9"/>Status:
<byte value="x9"/>X...pas ouvert aux matches
<byte value="x9"/>!...désire jouer (looking)
<byte value="x9"/>Q...ne reçoit pas les messages du serveur (quiet)
<byte value="x9"/>S...ne reçoit pas les chats (shouts)
<byte value="x9"/>??...inconnu - Le joueur est arrivé après la dernière mise à jour
Nom<byte value="x9"/>Nom du joueur
Rg<byte value="x9"/>Rang
Joue<byte value="x9"/>Joue la partie N° ... (une seule partie visible)
ob<byte value="x9"/>observe la partie N° ... (une seule partie visible)
Inactif<byte value="x9"/>Indique la durée d&apos;inactivité
X<byte value="x9"/>Info privée: M..moi, X..exclu, W..observé (tri: X d&apos;abord, puis Rg)

Ou, si l&apos;information étendue (Boîte à outils) est activée (IGS):

Info [Gagné/Perdu]  Inactif (Pays/Langue)<byte value="x9"/>&lt;je n&apos;ai pas pu faire de liste plus ergonomique. Si quelqu&apos;un est intéressé : envoyer un mail&gt;

Cette liste peut être réactualisée avec le bouton &apos;mise à jour des joueurs&apos;

Menu (click droit):
match<byte value="x9"/>demande de partie (boite de dialogue)
parler<byte value="x9"/>parler au joueur (étiquette)
----
statut<byte value="x9"/><byte value="x9"/>Indique le statut du joueur
parties stockées<byte value="x9"/>indique lesparties stockées sur le serveur (en général, inachevées)
résultats<byte value="x9"/><byte value="x9"/>montre les derniers résultats
classement<byte value="x9"/>montre le classement (seulement sur NNGS)
----
Liste d&apos;observation<byte value="x9"/>ajoute/enlève un joueur à la liste d&apos;observation: indique &apos;W&apos; dans la colonne &apos;X&apos; ; avertissement sonore quand un joueur entre/sort
Liste d&apos;exlusion<byte value="x9"/><byte value="x9"/>ajoute/enlève un joueur à la liste d&apos;exlusion : idem observation (indique un &apos;X&apos;). Les &apos;shouts&apos; du joueur n&apos;apparaissent plus
...
talk<byte value="x9"/>talk to player (tab arises)
----
status<byte value="x9"/><byte value="x9"/>show player&apos;s stats
stored games<byte value="x9"/>show stored games
results<byte value="x9"/><byte value="x9"/>show results
rating<byte value="x9"/><byte value="x9"/>show rating (NNGS/IGS only)
observe game<byte value="x9"/>show game currently played by player
...
TF<byte value="x9"/>teach tools / game tree</source>
...
Active / désactive l&apos;orientation verticale des commentaires.</translation>
    ...
    <message>
        <location filename="" line="0"/>
        <source>&amp;Previous move<byte value="x9"/>Left</source>
        <translation type="obsolete">Coup précédent (Gauche)</translation>
    </message>
    <message>
        <location filename="" line="0"/>
...
Délai entre les coups du déroulement automatique.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Titre, p.ex. : compte &apos;guest&apos; sur NNGS</translation>
    </message>
    <message>
...
Note: don&apos;t use a default server name, i.e. &apos;-- Aurora --&apos; etc.</source>
        <translation type="unfinished">Titre unique, p.ex. : 
...
Note : Ne pas utiliser le nom du serveur par défaut, comme  &apos;-- Aurora --&apos; etc.</translation>
    ...
    <message>
        ...
        <source>use your login name; if unregistered use a unique name like &apos;hotdog17&apos; (NNGS, CWS) or guest (other servers)</source>
        <translation type="unfinished">Utiliser votre login. Si vous n&apos;êtes pas enregistré, utilisez un nom peu usité &apos;trucmuche&apos; (NNGS, CWS) ou &apos;guest&apos; (autres serveurs)</translation>
    </message>
    <message>
...
others:<byte value="x9"/><byte value="x9"/>guest</source>
        <translation type="unfinished">Nom
...
Autres : &apos;guest&apos;</translation>
    ...
    <message>
        ...
        <source>port address, e.g.: 9696</source>
        <translation type="unfinished">adresse du port, p. ex : 9696</translation>
    </message>
    <message>
...
Port address is defined for each go server. It&apos;s a fixed number. See Host for predefined server names.</source>
        <translation type="unfinished">adresse du port, p. ex : 9696
...
L&apos;adresse du port est définie pour chaque serveur. C&apos;est un nombre fixe. Voir les serveurs pour les ports prédéfinis.</translation>
    ...
    <message>
        ...
        <source>your password; if unregistered: blank field</source>
        <translation type="unfinished">Votre mot de passe. Si vous nêtes pas enregistré : ne rien mettre</translation>
    </message>
    <message>
...
New users: leave blank!</source>
        <translation type="unfinished">Mot de passe:
...
nouvel arrivant : laissez en blanc!</translation>
    ...
    <message>
        ...
        <source>clear form</source>
        <translation type="unfinished">Effacer les données</translation>
    </message>
    <message>
...
clear form; doesn&apos;t make any changes to the entries</source>
        <translation type="unfinished">Nouveau
...
Effacer les données; aucun changement enregistré</translation>
    ...
    <message>
        ...
        <source>add/change current entry</source>
        <translation type="unfinished">Ajoute / change le champ courant</translation>
    </message>
    <message>
...
Label &apos;Add&apos; is default. The given entries will be saved under the given title.</source>
        <translation type="unfinished">Ajoute ou Change
...
&apos;Ajoute&apos; est le défaut. Les données seront enregistrées sous le nouveau titre.</translation>
    ...
    <message>
        ...
        <source>delete current entry</source>
        <translation type="unfinished">Supprime le champ en cours</translation>
    </message>
    <message>
...
Note: &apos;Delete&apos; concerns saved records.</source>
        <translation type="unfinished">Supprimer
...
<context>
    ...
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="13"/>
        <source>Welcome</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="14"/>
        <source>Hello!</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="15"/>
        <source>Nice to meet you</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="16"/>
        <source>Glad to know you</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="17"/>
        <source>Do you want a quick game?</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="18"/>
        <source>Do you want a game?</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="19"/>
        <source>I&apos;ll create multi room.</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="20"/>
        <source>Enter for pair baduk</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="21"/>
        <source>Request me for regular game</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="22"/>
        <source>Alright, no problem</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="23"/>
        <source>Yes, you are right</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="24"/>
        <source>I agree with you</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="25"/>
        <source>I agree</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="26"/>
        <source>Suit yourself</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="28"/>
        <source>I&apos;m sorry</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="29"/>
        <source>Sorry, I was chatting</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="30"/>
        <source>I just played a game</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="31"/>
        <source>I have to go now</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="32"/>
    ...
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="55"/>
    ...
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="61"/>
    ...
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="67"/>
    ...
    <message>
        <location filename="../network/orosetphrasechat.cpp" line="49"/>
...
<context>
    ...
    <message>
        <location filename="../game_interfaces/resultdialog.cpp" line="31"/>
        <source>&amp;Rematch?</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../game_interfaces/resultdialog.cpp" line="37"/>
        <source>&amp;Okay</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../game_interfaces/resultdialog.cpp" line="51"/>
        <source>Game </source>
        <translation type="unfinished"></translation>
    </message>
</context>
...
<context>
    ...
    <message>
        <location filename="../game_interfaces/undoprompt.cpp" line="11"/>
        <source>%1 wants to undo the last move</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../game_interfaces/undoprompt.cpp" line="13"/>
        <source>%1 wants to undo to move %2</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../game_interfaces/undoprompt.cpp" line="18"/>
        <source>Undo the last move?</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../game_interfaces/undoprompt.cpp" line="21"/>
        <source>Undo to what move?</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
        <location filename="../game_interfaces/undoprompt.cpp" line="30"/>
        <source>&amp;Accept</source>
        <translation type="unfinished"></translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../game_interfaces/undoprompt.cpp" line="60"/>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Partie n° </translation>
    </message>
    <message>
